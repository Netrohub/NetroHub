                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6" id="loginForm">
                    ...
                    <div>
                        <button type="submit" 
                                ...
                                @submit="busy=true" 
                                :disabled="busy"
                                class="w-full btn-glow group px-6 py-3 rounded-lg text-primary-foreground font-semibold text-lg shadow-lg disabled:opacity-50 disabled:cursor-not-allowed">
