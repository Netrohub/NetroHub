...
<div class="glass-card overflow-hidden group">
    ...
    <div class="p-4 pt-0">
        <button class="group w-full gap-2 btn-glow flex items-center justify-center px-4 py-2 rounded-lg text-primary-foreground font-semibold transition-all duration-300">
