...
@php
$baseClasses = 'w-full px-3 py-2 sm:px-4 sm:py-3 text-sm sm:text-base bg-dark-700/50 backdrop-blur-sm border rounded-lg sm:rounded-xl text-white placeholder-muted-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-dark-900 transition-all duration-300 min-h-[44px]';
$variantClasses = [
...
<div class="relative">
    ...
    @if($error)
        <p class="mt-1.5 sm:mt-2 text-xs sm:text-sm text-red-400 flex items-center">
