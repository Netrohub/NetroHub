...
@section('content')
<div class="min-h-screen relative overflow-hidden bg-gradient-to-br from-gray-900 via-slate-900 to-blue-900">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8 animate-fade-in-down">
            <a href="{{ route('sell.index') }}" class="group inline-flex items-center text-blue-400 hover:text-blue-300 mb-6 transition-all duration-300">
            ...
            <div class="flex items-center space-x-4 mb-4">
                <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-lg shadow-blue-500/50">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z" />
                    </svg>
                </div>
                <div>
                    <h1 class="text-5xl font-black text-white mb-2 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                        Sell a Game Account
                    </h1>
                    <p class="text-gray-400 text-lg">List your gaming account and start earning</p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-8 animate-fade-in" id="kyc-banner">
            <div class="bg-gradient-to-r from-yellow-900/40 to-orange-900/40 backdrop-blur-xl border border-yellow-500/30 rounded-2xl p-6 shadow-xl">
                ...
                <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="group">
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title') }}" required maxlength="190"
                                    ...
                                    class="w-full px-5 py-4 bg-gray-900/50 border-2 border-gray-700/50 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 group-hover:border-gray-600 @error('title') border-red-500 @enderror">
                                @error('title')
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        <select name="game_category" id="game_category"
                                            class="w-full px-5 py-4 bg-gray-900/50 border-2 border-gray-700/50 rounded-xl text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 appearance-none group-hover:border-gray-600">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        <select name="platform" id="platform" required
                                            class="w-full px-5 py-4 bg-gray-900/50 border-2 border-gray-700/50 rounded-xl text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 appearance-none group-hover:border-gray-600 @error('platform') border-red-500 @enderror">
                            ...
                            <div class="group">
                                ...
                                <textarea name="description" id="description" rows="8" required minlength="50"
                                    ...
                                    class="w-full px-5 py-4 bg-gray-900/50 border-2 border-gray-700/50 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 resize-none group-hover:border-gray-600 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="price" id="price" value="{{ old('price') }}" step="0.01" min="0.01" required
                                        placeholder="0.00"
                                        class="w-full pl-12 pr-5 py-4 bg-gray-900/50 border-2 border-gray-700/50 rounded-xl text-white text-xl font-semibold placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 group-hover:border-gray-600 @error('price') border-red-500 @enderror">
                                </div>
                                @error('price')
                                    <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                        ...
                        <div>
                            ...
                            <div class="relative border-2 border-dashed border-gray-700/50 rounded-2xl p-12 text-center hover:border-blue-500/50 transition-all duration-300 cursor-pointer group bg-gray-900/30" onclick="document.getElementById('images').click()">
                    ...
                    <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                        ...
                        <div class="space-y-5">
                            <label class="flex items-start p-5 rounded-xl border-2 border-gray-700/50 hover:border-blue-500/50 cursor-pointer group transition-all duration-300 bg-gray-900/30">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <button type="button" id="btn-list-game" 
                            data-flow="game"
                            class="flex-1 group relative overflow-hidden bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold py-5 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg shadow-blue-500/50">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl sticky top-8">
                        ...
                        <div class="space-y-6">
                            <!-- Platform Badge -->
                            <div class="relative">
                                <div class="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl blur-xl opacity-50"></div>
                                <div class="relative w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center overflow-hidden">
                            ...
                            <div class="pt-4 border-t border-white/10">
                                ...
                                <p id="preview-price" class="text-4xl font-black text-transparent bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text">$0.00</p>
                            </div>
